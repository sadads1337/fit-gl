...
GLDirectedLight::GLDirectedLight(QVector3D _position, QColor _color, const float _intensity)
...
void GLDirectedLight::upload_to_shader(const std::shared_ptr<QOpenGLShaderProgram>& shader, const size_t index)
{
