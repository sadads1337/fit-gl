...
public:
  GLCubeMeshGenerator(float edge_len, unsigned steps_count);
...
private:
  ...
  void rotate_face(std::vector<GLVertex> &plane_vertices,
  ...
  void init_vertices(std::vector<GLVertex> &vertices,
