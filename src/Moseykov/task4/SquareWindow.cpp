...
void SquareWindow::init_textures() {
  //        texture =
  //        std::make_shared<QOpenGLTexture>(QImage(":/Texture/almaz.png").mirrored());
  //        normal_map =
  //        std::make_shared<QOpenGLTexture>(QImage(":/Texture/almaz-map.png").mirrored());
  texture = std::make_shared<QOpenGLTexture>(
      QImage(":/Texture/raccon.jpg").mirrored());
  normal_map = std::make_shared<QOpenGLTexture>(
      QImage(":/Texture/raccon-map.jpg").mirrored());
