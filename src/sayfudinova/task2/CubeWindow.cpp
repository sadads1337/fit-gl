...
constexpr std::array<QVector3D, 194> vertices = {
...
constexpr std::array<GLuint, 768u> indices = {
...
void CubeWindow::render() {
  ...
  // Draw
  glDrawElements(GL_QUADS, static_cast<GLsizei>(indices.size()),
