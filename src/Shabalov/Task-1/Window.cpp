...
Window::Window() {
  ...
  connect(xSlider.get(), &QSlider::valueChanged, widget.get(),
          &Widget::setXRotation);
  connect(ySlider.get(), &QSlider::valueChanged, widget.get(),
          &Widget::setYRotation);
  connect(zSlider.get(), &QSlider::valueChanged, widget.get(),
          &Widget::setZRotation);
  connect(color.get(), &QColorDialog::currentColorChanged, widget.get(),
          &Widget::setColor);
