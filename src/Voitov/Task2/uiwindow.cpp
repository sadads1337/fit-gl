...
void UIWindow::render()
{
    ...
    matrix.rotate(speed * frame_ / 100, this->figure->getRotationAxis());
    ...
    glDrawElements(GL_LINE_STRIP, static_cast<GLsizei>(this->figure->getIndexes().size()), GL_UNSIGNED_INT, nullptr);
