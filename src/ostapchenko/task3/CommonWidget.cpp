...
CommonWidget::CommonWidget()
{
        ...
        connect(tSlider, &QSlider::valueChanged, Mwindow, &fgl::MainWindow::set_morph_param);
        connect(color, &QColorDialog::currentColorChanged, Mwindow, &fgl::MainWindow::set_color);
}